...
def Measure_sum(mes_l):
    """
    Sum a list of ufl.measure.Measure. Needed because Measure does not
    implement __radd__.

    Parameters
    ----------
    mes_l : list of ufl.measure.Measure
        List of measures to be summed.

    Returns
    -------
    mes : ufl.measure.Measure
        Sum.
    ...
    if len(mes_l)==1:
        ...
        mes = sum(mes_l[1:], mes_l[0]) # custom starting term
    return mes
