...
gmsh_utils.generate_mesh_cli(geofile,mshfile,2,refinement=1,log=1,\
...
gmsh_utils.generate_mesh_cli(geofile,mshfile,3,refinement=0,log=1,\
                             parameters={'R_mi':0.5,'R_ma':1,'lc':1/2},order=1,binary=True)
gmsh_utils.print_summary(mshfile)