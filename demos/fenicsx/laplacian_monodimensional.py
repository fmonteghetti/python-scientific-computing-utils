...
diag_A = 1e2
diag_B = 1e-2
(GEP_A,GEP_B) = fenicsx_utils.assemble_GEP(a,b,bcs,diag_A=diag_A,diag_B=diag_B)
    # Solve
OptDB = PETSc.Options()
OptDB["st_ksp_type"] = "preonly"
OptDB["st_pc_type"] = "lu"
OptDB["st_pc_factor_mat_solver_type"] = "mumps"
EPS = SLEPc_utils.solve_GEP_shiftinvert(GEP_A,GEP_B,
                          problem_type=SLEPc.EPS.ProblemType.GHEP,
                          solver=SLEPc.EPS.Type.KRYLOVSCHUR,
                          nev=50,tol=1e-8,max_it=1000,
                          target=4,shift=4)
    # Plot
i_plot = 2
