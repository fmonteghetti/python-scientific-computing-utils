...
imp_mod = DAE_description(
    y0, yd0, name="Example using the Jacobian Vector product"
)
# imp_mod.algvar = idx
...
imp_sim.tout1 = 0.001
print(
    f"Residual call: {imp_sim.problem.res_count}, Jacobian call: {imp_sim.problem.jac_count}"
)
# Misc
